      				...
      				<div class="showback">
      					<h4><i class="fa fa-angle-right"></i> Check your application status</h4>
                                    ...
                                    <div class="row" style="text-align: center;">
                                       ...
                                       <div class="col-md-6">
                                          <form method="post" action="<?php echo base_url();?>home/check_status">
                                             <label>Enter you CNIC/B-Form to check you application</label>
                                             <div class="form-group">
                                                <input type="number" name="cnic" class="form-control" pattern="[0-9]{13}" placeholder="xxxxxxxxxxxxx">
                                             </div>
                                             <div class="form-group">
