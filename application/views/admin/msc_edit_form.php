    ...
    foreach ($mcs_students as $details) {
            ...
            <div class="row mt">
              ...
              <div class="col-lg-8">
                  <div class="form-panel">
                      ...
                      <form class="form-horizontal style-form" method="post" action="<?php echo base_url();?>admin/updated_msc_student_details" enctype="multipart/form-data"a name="form_reg">
                                ...
                                <label>Program</label>
                                  ...
                                  <select class="form-control" name="st_program">
                                    <option value="<?php echo $details->st_program; ?>" selected><?php echo $details->st_program; ?></option>
                                     <?php foreach($msc_programs as $program){?>
