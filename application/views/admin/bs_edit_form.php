    ...
    foreach ($bs_students as $details) {
            ...
            <div class="row mt">
              ...
              <div class="col-lg-8">
                  <div class="form-panel">
                      ...
                      <form class="form-horizontal style-form" method="post" action="<?php echo base_url();?>admin/updated_bs_student_details" enctype="multipart/form-data"a name="form_reg">
                          ...
                          <div class="col-sm-10">
                              <table class="table table-bordered table-condensed table-hover">
                                <tr>
                                  ...
                                  <td colspan="2"><input type="radio" name="applyforcourse" value="M.Sc"> MA/M.Sc/BBA(2year)</td>
                                  <tr>
                                      <td></td>
                                  <td><input type="radio" name="applyforcourse" value="MS"> MS/M.Phill/M.Sc(Hons)</td>
                                  <td colspan="2"><input type="radio" name="applyforcourse" value="B.Ed"> B.Ed</td>
                                  </tr>
                              ...
                              <div class="col-sm-5">
                                <label>Program</label>
                                  ...
                                  <select class="form-control" name="st_program">
                                    ...
                                    <?php foreach($bs_programs as $program){?>
...
<div class="form-group">
                      ...
                      <textarea class="form-control" placeholder="Your remarks about what you updated in the form. Thank you!" name="remarks" required=""></textarea>
