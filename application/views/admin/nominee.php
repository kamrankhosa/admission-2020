   ...
   <!--main content start-->
      <section id="main-content">
          <section class="wrapper">
          	 <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line text-center"><?php echo $title; ?></h1>
                                ...
                                <table class="table table-striped table-bordered table-hover table-condensed" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td><?php echo $bs_student->category; ?></td>
                                            ...
                                            <td>
                                              <a href="<?php echo base_url();?>admin/bs_edit_form?id=<?php echo base64_encode($bs_student->ID) ?>">
                                                <!--<button class="btn btn-primary btn-xs" data-toggle="modal" data-target="#editModal"><i class="fa fa-pencil" title="Update"></i></button></a>-->
