...
?>  
   <!--main content start-->
      <section id="main-content">
          <section class="wrapper">
          	 <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line text-center">MS Registered Students</h1>
              	 ...
              	 <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                          ...
                          <span><a href="<?php echo base_url(); ?>admin/exportCSV_ms" class="btn btn-success">Download File</a></span>
                          <?php }?>
                        </div>
   ...
   <td>
                                               ...
                                               <a href="<?php echo base_url();?>admin/ms_edit_form?id=<?php echo base64_encode($ms_student->ID) ?>"> <button class="btn btn-primary btn-xs" data-toggle="modal" data-target="#editModal"><i class="fa fa-pencil" title="Update"></i></button></a>
                                      <?php }?>
                                     ...
                                     <?php }?>
                                            ...
                                            <td><?php echo $ms_student->dob; ?></td>
                                            <td><?php echo $ms_student->ep_name; ?></td>
                                            <td><?php echo $ms_student->g_cellno; ?></td>
                                            <td><?php if(!empty($ms_student->master_year)){
                                            echo $ms_student->master_year; 
                                                
                                            }
                                            else{
                                               echo $ms_student->bachelor_year; 
                                            }
                                            ?></td>
                                            <td><?php if(!empty($ms_student->master_percentage)){
                                            echo round($ms_student->master_percentage,2); 
                              ...
                              <div class="modal-body">
                                    <form method="post" action="<?php echo base_url();?>admin/update_ms_student_status">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="status" onchange="show_na(this)">
                                        ...
                                        <div class="form-group">
                                          <input type="text" required="" class="form-control" name="na_reason" placeholder="Please provide a solid reason for N/A because it will be shown to the students." id="na_reason">
