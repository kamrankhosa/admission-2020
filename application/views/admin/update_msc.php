          ...
          <section class="wrapper" style="padding-bottom: 180px;">
              ...
              <div class="col-lg-2">
                  ...
                  <div class="form-panel">
                  	  <h4 class="mb text-center"> Update Record (M.Sc)</h4>
                      <form class="form-horizontal style-form" method="get" action="<?php echo base_url(); ?>admin/msc_edit_form1">
                         ...
                         <div class="form-group">
                          ...
                          <input type="submit" name="sub" value="Show Record" class="btn btn-success btn-lg"/>
                          </div>
                      </form>
                  </div>
          		</div><!-- col-lg-12-->   
