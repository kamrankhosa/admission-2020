        ...
        <div class="panel panel-default" data-collapsed="0"
          style="border-color: #dedede;">
            ...
            <p style="font-size: 14px;">
              Welcome to <b>Banado</b> App Installation. You will need to know the following information before
              proceed to install.
            </p>
            <ol>
              <li>Database Name</li>
            ...
            <p style="font-size: 14px;">
              Gather the information mentioned above before hitting the start installation Process button. If you are ready....
            </p>
            <br>
            <p>
